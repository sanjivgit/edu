...
export default function DiaryPage() {
  return (
    <Routes>
      ...
      <Route path="create" element={<RequireRole roles={[...ACCESS.manageDiary]}><DiaryCreatePage /></RequireRole>} />
      <Route path=":entryId" element={<DiaryDetailPage />} />
      <Route path=":entryId/edit" element={<RequireRole roles={[...ACCESS.manageDiary]}><DiaryEditPage /></RequireRole>} />
    </Routes>
  );
}
