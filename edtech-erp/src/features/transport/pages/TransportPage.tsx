...
export default function TransportPage() {
  return (
    <Routes>
      ...
      <Route path="routes/create" element={<RequireRole roles={[...ACCESS.manageTransport]}><TransportRouteCreatePage /></RequireRole>} />
      <Route path="routes/:routeId" element={<TransportRouteDetailPage />} />
      <Route path="routes/:routeId/edit" element={<RequireRole roles={[...ACCESS.manageTransport]}><TransportRouteEditPage /></RequireRole>} />
    </Routes>
  );
}
